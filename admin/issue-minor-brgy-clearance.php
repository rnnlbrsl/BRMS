...
$page = 'clearance';
$menu = 'minor';
$sql_n = "SELECT count(minor_clearance_no) as count FROM minor_brgy_clearance";
...
<body>
  <div class="wrapper">
    ...
    if(isset($mysqli,$_POST['submit']))
    {
        ...
        $sql = "INSERT INTO minor_brgy_clearance (resident_no, purpose, issued_at)
        ...
        { 
            ...
            if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') {
                //load spreadsheet
                $spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load("minor.xlsx");
                ...
                if (!file_exists('clearance/minor/'.$resident_id.'_clearance')) {
                    mkdir('clearance/minor/'.$resident_id.'_clearance');
                }

                $random = mt_rand();
                //write it again to Filesystem with the same name (=replace)
                $file = './clearance/minor/'.$resident_id.'_clearance/'.$resident_id.'_'.$today.'_'.$random.'.xlsx';
        ...
        <div class="panel panel-default sammacmedia">
            ...
            <div class="panel-body">
                <form method="post" action="BarangayClearanceminor.php">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <button type="submit" name="submit" class="btn btn-suc btn-block"><span class="fa fa-plus"></span> Issue</button>  
                        </div>
                        <div class="col-md-6">
