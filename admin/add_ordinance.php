  ...
  <div class="wrapper">
    ...
    <div id="content">
        ...
        if(isset($mysqli,$_POST['submit']))
        {
            ...
            $sql = "INSERT INTO ordinances (official_id, title, details, date_created)
                VALUES('$official_id','$title','$details','$datecreated')";
            $results = mysqli_query($mysqli,$sql);
            if($results==1)
            { ?>
                <div class="alert alert-success animated bounce" id="sams1">
                    <a href="#" class="close" data-dismiss="alert">&times;</a>
                    <strong> Successfully! </strong><?php echo'created an ordinance';?>
                </div>
            <?php } else { ?>
